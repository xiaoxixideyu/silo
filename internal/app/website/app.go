...
import (
	...
	_ "silo/api/website" // This line is important for swagger
...
// NewApp 创建website应用
func NewApp(cfg *config.CommonConfig, e *echo.Echo, websiteHandler handler.WebsiteHandler, db *gorm.DB) *App {
